...
AMUN SIGNAL aggregates publicly available data from many third-party sources.
...
AMUN SIGNAL itself is licensed under AGPL-3.0 (see `LICENSE`). **This file
...
**Attribution requirement:** the AMUN SIGNAL map UI displays
...
If you represent a data provider and have concerns about how AMUN SIGNAL
uses your data, please open an issue or contact the maintainer at
open a GitHub issue in `eldoctorams/Amun-Signal`. We will respond promptly and, if needed, adjust
